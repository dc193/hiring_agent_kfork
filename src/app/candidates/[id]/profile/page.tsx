...
import { SummaryCard, SubPageHeader, ProfilePageClient } from "@/components/profile";
    ...
    <PageLayout>
      ...
      <ProfilePageClient
        ...
        profileData={profile ? {
          ...
          hardSkills: profile.hardSkills as Array<{ name: string; level: number }> | null,
          softSkills: profile.softSkills as Array<{ name: string; level: number }> | null,
          certifications: profile.certifications as string[] | null,
          behaviorPatterns: profile.behaviorPatterns as Record<string, string> | null,
          socialPosition: profile.socialPosition as Record<string, string> | null,
          resources: profile.resources as Record<string, string> | null,
